...
%               ПРАВИЛА
% 1. Вывод списка всех стран с их главами и столицами
список_стран :-
	страна(_, Название_Страны, _, _),
	столица(_, Название_Столицы, _),
	глава(_, Имя_Главы, _, _),
	write(Имя_Главы, " является главой ", Название_страны, ", а столица ", Название_Столицы), nl, fail.

% 2. Вывод стран, где есть ядерное оружие
ядерные_страны(Есть_оружие) :-
	ядерное_оружие_наличие(19, ID_СТРАНЫ),
	страна(ID_СТРАНЫ, Название_Страны, _, _),
	write("У ", Название_страны, " есть ядерное оружие "), nl, fail.

% 3. Вывод стран по части света
части_света(Часть_Света) :-
	страна(_, Название_Страны, Часть_Света, _),
	write(Название_страны, " находится в ", Часть_Света), nl, fail.
